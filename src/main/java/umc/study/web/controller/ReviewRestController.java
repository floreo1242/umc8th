...
public class ReviewRestController {
    ...
    public ApiResponse<ReviewResponseDTO.ReviewPreviewListDTO> getReviewList(@RequestParam(name = "page") @ValidPage Integer page) {
        int internalPage = page - 1;
        Page<Review> reviewList = reviewService.getMyReviewList(internalPage);
        return ApiResponse.onSuccess(ReviewConverter.reviewPreviewListDTO(reviewList));
    }
}